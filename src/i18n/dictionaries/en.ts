...
export const en: typeof tr = {
  ...
  blogForm: {
    ...
    slugLabel: "URL (slug)",
    slugPrefix: "/blog/",
    slugPh: "example-post-url",
    excerpt: "Excerpt",
    excerptPh: "Short summary shown in listings and search results...",
    content: "Content",
    statusLabel: "Status",
    draft: "Draft",
    published: "Published",
    ...
    saveError: "The post could not be saved.",
    category: "Category",
    categoryPh: "e.g. Skincare",
    tags: "Tags",
    tagsPh: "Separate with commas: laser, maslak",
    cover: "Cover Image",
    coverAlt: "Cover image preview",
    seo: "Set how this post appears in search engines.",
    seoTitle: "SEO Title",
