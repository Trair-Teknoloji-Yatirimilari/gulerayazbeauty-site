...
export const tr = {
  ...
  blogForm: {
    titleLabel: "Başlık",
    slugLabel: "URL Adresi (slug)",
    slugPrefix: "/blog/",
    slugPh: "ornek-yazi-adresi",
    excerpt: "Özet",
    excerptPh: "Listede ve arama sonuçlarında görünecek kısa özet...",
    content: "İçerik",
    statusLabel: "Durum",
    draft: "Taslak",
    published: "Yayında",
    ...
    saveError: "Yazı kaydedilemedi.",
    category: "Kategori",
    categoryPh: "Örn. Cilt Bakımı",
    tags: "Etiketler",
    tagsPh: "Virgülle ayırın: lazer, maslak",
    cover: "Kapak Görseli",
    coverAlt: "Kapak görseli önizlemesi",
    seo: "Arama motorlarında nasıl görüneceğini buradan ayarlayabilirsiniz.",
  ...
  editor: {
    ...
    undo: "Geri al",
    redo: "İleri al",
    urlPrompt: "Bağlantı adresini girin:",
    imagePrompt: "Görsel adresini girin:",
  },
  blogAdmin: {
